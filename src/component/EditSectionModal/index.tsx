...
const EditSectionModal = ({ editOpen, closeEditModal, sectionId  }) => {
...
const icons = [
  ...
  const handleSave = () => {
    ...
    updateSection( sectionId, { name, year: parseInt(year, 10), icon: selectedIcon });
    setName('');
    setYear('');
  ...
  return (
     <div className="modal-container" onClick={closeEditModal}>
